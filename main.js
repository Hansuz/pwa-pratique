...
function loadTechnologies(technos) {
    fetch('https://us-central1-pwa-technos-acf5c.cloudfunctions.net/getTechnos')
        .then(response => {
            response.json()
                .then(technos => {
...
if(navigator.serviceWorker) {
    ...
    navigator.serviceWorker
        ...
        .then(registration =>{
            ...
            const publicKey = "BIsyaeaxawWPd8u28hBd1BSa1jUSqN6ik0wDm2zilCQfqYwSEQGL_o9v9wJVfRizQ5ZK13z_MyGDPsWsQBWRDZM";
